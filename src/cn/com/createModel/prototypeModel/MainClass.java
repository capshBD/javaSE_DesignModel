...
public class MainClass {
	public static void main(String[] args) throws Exception {
		...
		Person pp=(Person) manger.getPrototype("cn.com.createModel.prototypeModel.Person");
		pp.setAge(45);
		pp.setSex("girl");
		...
		Person pp2=(Person) PrototypeManager.getPrototypeManager().getPrototype("cn.com.createModel.prototypeModel.Person");
